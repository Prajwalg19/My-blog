...
const OAuth = () => {
    ...
    return (
        <Button disabled={loading} type="button" onClick={handleOAuth} className="w-full hover:text-white" gradientMonochrome="purple" outline><span className="font-semibold flex flex-row gap-2 items-center justify-center"> <FcGoogle /> <span>Google</span></span></Button>
    )
}
